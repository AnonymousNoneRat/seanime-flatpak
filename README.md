...
This is an **unofficial** community package. Seanime is developed by [5rahim](https://github.com/5rahim/sean ```markdown
# Seanime Flatpak
...
This is an **unofficial** community package. Seanime is developed by [5rahim](https://github.com/5rahim/seanime).
```ime).
```
